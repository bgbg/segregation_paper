...
The following tables and figures provide full transition matrices for all analyzed cities across consecutive elections. These details complement the summary presented in the main text and allow replication of city-specific patterns.
