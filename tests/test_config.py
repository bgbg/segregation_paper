...
def test_config_parameter_ranges(sample_config):
    ...
    assert sample_config['model']['kappa_prior_scale'] > 0, "kappa_prior_scale should be positive"
    ...
    assert 0.0 < sampling['target_accept'] < 1.0, "target_accept should be between 0 and 1"
