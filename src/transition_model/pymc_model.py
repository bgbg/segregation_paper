...
def generate_test_data() -> Dict[str, Dict[str, np.ndarray]]:
    ...
    # Country data
    x1_country = np.random.multinomial(500, [0.15, 0.12, 0.63, 0.10], n_stations_country)
    x2_country = np.random.multinomial(520, [0.16, 0.11, 0.65, 0.08], n_stations_country)
...
if __name__ == "__main__":
    ...
    try:
        ...
        print("And system graphviz: brew install graphviz (macOS) or apt-get install graphviz (Linux)")